...
print('Examples are any result*.txt file in the output directory.')
print('The ones with dft in their name are to be used with load_result_dft.py instead, so please do not load them with this script.')
