...
class IterativeRenormalisedSolver {
  public:
    ...
    void solveInward(std::vector<ldouble> &E, std::vector<int> &l, std::vector<MatrixXld> &Fm, std::vector<MatrixXld> &Km, std::vector<MatrixXld> &Cm, std::vector<MatrixXld> &R);
    ...
    /// \param Cm K matrix.
    /// \param R Orbital ratio matrix for different initial condition assumptions.
    void solveOutward(std::vector<ldouble> &E, std::vector<int> &l, std::vector<MatrixXld> &Fm, std::vector<MatrixXld> &Km, std::vector<MatrixXld> &Cm, std::vector<MatrixXld> &R);
